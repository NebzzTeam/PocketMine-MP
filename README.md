Nebzz-PocketMine-MP
=======
This project is response to this [thread](https://forums.pmmp.io/threads/nebzz-a-fork-of-pmmp-which-violates-lgpl.3461/).

Nebzz it self is generated by Nebzz Generator which can auto patch methods(patches are provided in *.nbp files) with some small changes and then generates the packed file.

Big changes has been included in this project.

ZXDA Platform Management Team & Nebzz Development Team
