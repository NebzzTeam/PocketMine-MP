...
Nebzz it self is generated by Nebzz-Generator which can auto patch methods(patches are provided in *.nbp files) with some small changes and the generate the packed file.
